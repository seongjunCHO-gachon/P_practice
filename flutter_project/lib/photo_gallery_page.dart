...
class _PhotoGalleryPageState extends State<PhotoGalleryPage> {
  ...
  Future<bool> _requestManageFilesPermission() async {
  ...
  Future<void> _pickFolder() async {
    ...
    if (directoryPath != null) {
      ...
      setState(() {
        ...
        print("선택된 경로 : $selectedFolderPath");
      });
    }
  }
  ...
  Future<void> _handleLogout(BuildContext context) async {
    try {
      ...
      print("SharedPreferences 처리 중 오류 발생: $e");
    }
  }
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                const String uid = '12345'; // 고정된 사용자 UID
                ...
                try {
                  await uploadService.uploadPhotosFromFolder(selectedFolderPath!, uid);
                  ScaffoldMessenger.of(context).showSnackBar(
